      ...
      <div className="w-full min-h-full bg-[#FFFCEF]">
          ...
          <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
            ...
            <header className="flex justify-between items-center mb-16">
              <div className="text-xl text-block font-bold">
                GoosePrep 
              </div>
              {user ? (
                <ProfileInfoCard />
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="w-full md:w-1/2">
                <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                  Level up your co-op search. Generate role-specific questions, expand answers when your stuck,
                  and dive deeper into technical concepts. From preperation to offer - GoosePrep is your ultimate interview toolkit.
                </p>
